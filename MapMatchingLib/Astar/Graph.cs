...
namespace MapMatchingLib.Astar
{
    ...
    public class Graph
    {
        ...
        private readonly Dictionary<long, Arc> _arcsDict;
        ...
        public Graph()
        {
            ...
            _arcsDict= new Dictionary<long, Arc>();
        }
        ...
        public bool AddArc(Arc newArc)
        {
            ...
            if(newArc.Id!="0"&& newArc.GetType() != typeof(TempArc))
                _arcsDict[long.Parse(newArc.Id)] = newArc;
            return true;
        }
